        ...
        <div className="relative flex flex-col items-start gap-11">
          ...
          <div className="text-white">
            <p className="mb-2 uppercase">
              Special Administrative Region in Bhutan
            </p>
            <h1 className="font-bebas mb-6 text-5xl tracking-widest">
              Gelephu Mindfulness City
            </h1>
            <p className="max-w-md text-base text-gray-300">
              Bhutan&apos;s commitment to sustainable development, rich cultural
              heritage, and strong governace, positions the City as global
              leader in mindful and sustainable urban growth.
            </p>
          </div>
          ...
          <Button
            ...
            icon={<HiOutlinePlayCircle size={24} />}
...
const About = () => {
  return (
    <section className="relative h-screen w-screen overflow-hidden">
      ...
      <div className="absolute bottom-11 left-24 z-50 text-white">
        <h2 className="font-bebas mb-6 max-w-2xl text-4xl font-semibold capitalize">
          New Global Leader in mindful and sustainable urban growth.
        </h2>
        <p className="max-w-xl">
          World-class infrastructure seamlessly integrates state-of-the-art
          technology with sustainable practices. Connected through international
          airport, advanced rail networks, and cutting-edge digital systems -
          all powered by 100% renewable energy, ensuring life and business
